...
const ReadyParties = ({
  ...
  return <Card>
      ...
      <CardContent>
        {readyParties.length === 0 ? <p className="text-gray-500 text-center py-4">
            Nenhum cliente aguardando confirmação
          </p> : <div className="space-y-3">
            {readyParties.map(party => <div key={party.party_id} className="flex items-center justify-between p-4 border rounded-lg bg-yellow-50">
                <div>
                ...
                <div className="flex gap-2">
                  <Button size="sm" onClick={() => onConfirmArrival(party.party_id)} className="bg-green-600 hover:bg-green-700">
